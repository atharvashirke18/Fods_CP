...
void MusicController::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->playlistCreated((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1]))); break;
        case 2: _t->playlistDeleted((*reinterpret_cast<std::add_pointer_t<int>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (MusicController::*)(int )>(_a, &MusicController::libraryLoaded, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (MusicController::*)(QString )>(_a, &MusicController::playlistCreated, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (MusicController::*)(int )>(_a, &MusicController::playlistDeleted, 2))
            return;
    }
}
